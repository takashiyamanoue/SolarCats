...
r=ex(ft,m2+"set-count 7 0")
r=ex(ft,m2+"set-motor-while-count lt 4 1 7 61")
r=ex(ft,m2+"set-motor-until-digital on 4 2 8")
r=ex(ft,m2+"set-count 7 0")
r=ex(ft,m2+"get-digital 1"+master)
? ex("FT-Controller-(master)","getReturn")
...
r=ex(ft,m1+"set-count 5 0")
r=ex(ft,m1+"set-motor-while-count lt 3 1 5 61")
r=ex(ft,m1+"set-motor-until-digital on 3 2 6")
r=ex(ft,m1+"get-digital 1"+master)
? ex("FT-Controller-(master)","getReturn")
'
'step 4 ... prepare to tite, tilte tilter-2
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 2 1 3 15")
r=ex(ft,m1+"get-digital 1"+master)
? ex(ft,"getReturn")
'
'step 5 ... tilte 
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 5")
r=ex(ft,m1+"set-motor-while-count lt 2 2 3 2")
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 3")
r=ex(ft,m1+"set-motor-while-count lt 2 2 3 3")
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 3")
r=ex(ft,m1+"set-motor-while-count lt 2 2 3 2")
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 2")
r=ex(ft,m1+"set-motor-while-count lt 2 2 3 2")
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 2")
...
r=ex(ft,m1+"set-count 1 0")
r=ex(ft,m1+"set-count 3 0")
r=ex(ft,m1+"set-motor-while-count lt 1 1 1 1")
r=ex(ft,m1+"set-motor-until-digital on 2 2 4")
r=ex(ft,m1+"set-motor-until-digital on 1 2 2")
r=ex(ft,m1+"get-digital 1"+master)
? ex(ft,"getReturn")
'
'step 6 return the dice to the horizontal turn table
r=ex(ft,m1+"set-count 7 0")
r=ex(ft,m1+"set-motor-while-count lt 4 1 7 62")
r=ex(ft,m1+"set-motor-until-digital on 4 2 8")
r=ex(ft,m1+"get-digital 1"+master)
? ex("FT-Controller-(master)","getReturn")
'
'step last... move little bit in order to keep sensors accurate
r=ex(ft,m1+"set-motor 1 1")
r=ex(ft,"waittime 1000")
r=ex(ft,m1+"set-motor 1 0")
r=ex(ft,m1+"set-motor 2 1")
r=ex(ft,"waittime 1000")
r=ex(ft, m1+"set-motor 2 0")
'
r=ex(ft,m1+"set-motor 3 1")
r=ex(ft,"waittime 1000")
r=ex(ft,m1+"set-motor 3 0")
r=ex(ft,m1+"set-motor 4 1")
r=ex(ft,"waittime 1000")
r=ex(ft, m1+"set-motor 4 0")
'
r=ex(ft,m2+"set-motor 3 1")
r=ex(ft,"waittime 1000")
r=ex(ft,m2+"set-motor 3 0")
r=ex(ft,m2+"set-motor 4 1")
r=ex(ft,"waittime 1000")
r=ex(ft, m2+"set-motor 4 0")
'
