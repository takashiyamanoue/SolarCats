...
//        fileDialog.setSeparator(separator);
	...
	//{{DECLARE_CONTROLS
	controlledparts.ControlledButton loadFromWebButton = new controlledparts.ControlledButton();
	controlledparts.ControlledButton loadFromFileButton = new controlledparts.ControlledButton();
	controlledparts.ControlledButton saveToFileButton = new controlledparts.ControlledButton();
	javax.swing.JLabel JLabel1 = new javax.swing.JLabel();
	controlledparts.ControlledButton loadFromUserFileButton = new controlledparts.ControlledButton();
	controlledparts.ControlledButton cancelButton = new controlledparts.ControlledButton();
	controlledparts.ControlledButton saveToCommonButton = new controlledparts.ControlledButton();
	//}}
