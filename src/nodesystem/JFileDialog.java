...
//		this.fileChooser= new JFileChooser();
	...
	//{{DECLARE_CONTROLS
	controlledparts.ControlledButton actionButton = new controlledparts.ControlledButton();
	...
	controlledparts.ControlledButton chooserButton = new controlledparts.ControlledButton();
	controlledparts.ControlledScrollPane controlledScrollPane1 = new controlledparts.ControlledScrollPane();
	controlledparts.ControlledTextArea fileNameField = new controlledparts.ControlledTextArea();
	controlledparts.ControlledScrollPane controlledScrollPane2 = new controlledparts.ControlledScrollPane();
	controlledparts.ControlledTextArea filePathField = new controlledparts.ControlledTextArea();
	//}}
