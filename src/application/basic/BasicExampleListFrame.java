...
* *************************************
*/
public class BasicExampleListFrame extends javax.swing.JFrame implements FrameWithControlledButton, StateContainer    
{
    public int getState()
    {
...
//        frame.sendEvent("bex.btn.enter("+i+")\n");
	...
	public BasicExampleListFrame()
	{
		...
		factorialButton.setActionCommand("factorial");
		getContentPane().add(factorialButton);
		factorialButton.setBackground(new java.awt.Color(204,204,204));
		factorialButton.setForeground(java.awt.Color.black);
		factorialButton.setFont(new Font("Dialog", Font.BOLD, 12));
		factorialButton.setBounds(12,12,156,24);
...
//		factorialButton.addActionListener(lSymAction);
		...
		programs=new Vector();
		buttons=new Vector();
		buttons.addElement(this.factorialButton);  
		programs.addElement("commondata/basic/factorial.bas");
		buttons.addElement(this.fibonacciButton);  
		programs.addElement("commondata/basic/fibonacci.bas");
		buttons.addElement(this.lines1Button);     
		programs.addElement("commondata/basic/lines-1.bas");
		buttons.addElement(this.sincurveButton);     
		programs.addElement("commondata/basic/sin-curve.bas");
		buttons.addElement(this.gaussButton);  
		programs.addElement("commondata/basic/gauss.bas");
		buttons.addElement(this.hanoiButton);     
		programs.addElement("commondata/basic/hanoi.bas");
		buttons.addElement(this.sieveButton);     
		programs.addElement("commondata/basic/sieve.bas");
		buttons.addElement(this.s2iButton);
		programs.addElement("commondata/basic/s2i.bas");
		buttons.addElement(this.mathButton);
		programs.addElement("commondata/basic/math-fun.bas");
		buttons.addElement(this.associateButton);
		programs.addElement("commondata/basic/associate.bas");
		buttons.addElement(this.while1Button);
		programs.addElement("commondata/basic/while-ex1.bas");
		...
		this.setTitle("BasicExampleList");
	
	}

	public BasicExampleListFrame(String sTitle)
	{
		this();
		setTitle(sTitle);
	}
	...
	{
		(new BasicExampleListFrame()).setVisible(true);
	}
	...
	//{{DECLARE_CONTROLS
	controlledparts.ControlledButton factorialButton = new controlledparts.ControlledButton();
