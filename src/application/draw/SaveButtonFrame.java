...
public class SaveButtonFrame extends JFrame
{
	...
	private SaveButtonDebuggFrame sframe;
	private PukiwikiApplet applet;
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				jLabel1.setText("Net Draw, A draw for pukiwiki ");
				jLabel1.setBounds(168, 3, 228, 25);
			}
			{
				jLabel2 = new JLabel();
				getContentPane().add(jLabel2);
				jLabel2.setText("Takashi Yamanoue , Kagohsima University, Japan");
	...
	public SaveButtonFrame(SaveButtonDebuggFrame x, PukiwikiApplet a){
		this.sframe=x;
		this.applet=a;
		this.initGUI();
	}
