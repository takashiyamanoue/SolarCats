...
/** optimized for write(byte[2]), constructed first.
  */
final class ParallelOutputStream extends OutputStream {
  private final int portHandle;
  
  ParallelOutputStream (String portName) throws IOException {
